🛡️ Stay Safe Online – Actionable Tips
...
-Before clicking any link, check the sender and URL carefully
-Use a password manager or note to keep different passwords for each app
-After using a college lab or cyber café, always log out of all accounts
-If someone harasses you online, take screenshots and block/report immediately
-Install apps only from Play Store/App Store, not from random links
...
-Don’t scan random QR codes sent on WhatsApp/Telegram
-Avoid screen sharing during payments (scammers misuse it)
